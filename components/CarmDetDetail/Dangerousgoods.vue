          ...
          <div class="flex flex-col md:flex-row md:space-x-4">
            ...
            <div class="w-full md:w-1/5">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                ...
                <label class="font-13-400">รหัสสินค้าอันตราย</label>
                <v-text-field
                  @keydown.enter="focusNext"
                  class="font-14-300"
                  solo
                ...
                <div class="w-full md:w-1/3">
                <label class="font-13-400">รหัสประเภทสินค้าอันตราย</label>
                <v-text-field
                  @keydown.enter="focusNext"
                  class="font-14-300"
                  solo
                ...
                <div class="w-full md:w-1/3">
                <label class="font-13-400">หมายเลขรหัสสินค้าอันตราย</label>
                <v-text-field
                  @keydown.enter="focusNext"
                  class="font-14-300"
                  solo
