            ...
            <v-radio-group v-model="ex7">
              <div class="flex flex-col md:flex-row md:space-x-4">
                <div class="-mt-3">
                  ...
                  <v-radio value="1" color="base_ex" class="pt-2"></v-radio>
                </div>
                <div class="-mt-3">
                  <label class="text-base pl-1 font-semibold">0</label>
                  <v-radio value="3" color="base_ex" class="pt-2"></v-radio>
                </div>
                <div class="-mt-3">
                  <label class="text-base pl-1 font-semibold">+</label>
                  <v-radio value="2" color="base_ex" class="pt-2"></v-radio>
                </div>
              </div>
            </v-radio-group>
          </div>
          ...
          <div class="w-full">
            <v-radio-group v-model="ex8">
              <div class="flex flex-col md:flex-row md:space-x-4">
                ...
                <div class="-mt-3">
                  <label class="text-base pl-1 font-semibold">0</label>
                  <v-radio color="base_ex" value="3" class="pt-2"></v-radio>
                </div>
                <div class="-mt-3">
                  <label class="text-base pl-1 font-semibold">+</label>
                  <v-radio color="base_ex" value="2" class="pt-2"></v-radio>
                </div>
              </div>
            </v-radio-group>
          </div>
