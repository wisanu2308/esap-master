    ...
    >
      <div class="flex h-full es-container">
        ...
        >
          ...
          <div v-else @click="$router.push({ path: '/fdapermit/fdapermitaddnew' })">
            <Core-ButtonHead
              class="ml-3"
    ...
    <v-bottom-sheet v-model="nav">
      <v-card class="p-4">
        <div v-for="menu in headerMenu" :key="menu.name">
          ...
          <div v-else @click="$router.push({ path: '/fda/fdaaddnew' })">
            <Core-ButtonHead
              class="w-full mt-2"
              :btnsave="menu.isBtnSave"
              :otherclass="menu.otherclass"
...
export default {
  ...
  data() {
    return {
      ...
      headerMenu: [
        ...
        {
          name: "Import",
          icon: require("@/assets/images/svg/good/import.svg"),
          iconColor: "#F1B44C",
          bgColor: this.bgcolor,
          isCustomIcon: true,
        },
        ...
        {
          name: "Print",
          icon: require("@/assets/images/svg/good/print.svg"),
          iconColor: "#F1B44C",
          bgColor: this.bgcolor,
          isCustomIcon: true,
        },
        {
          name: "Delete",
          icon: require("@/assets/images/svg/good/delete.svg"),
          iconColor: "#F1B44C",
          bgColor: this.bgcolor,
          isCustomIcon: true,
        },
  ...
  props: {
    name: {
      default: "FDA RESTRICT GOODS CONTROL",
    },
    title: {
      default: "FdaRestrictGoods / FdaRestrictGoods List /",
    },
    action: {
      default: "Add New",
    },
