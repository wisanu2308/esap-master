            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  @change=" changeCurrency($event, 'forwardingRateOth')"
                  @keydown.enter="getIndexListDropDown"
                >
                  <template slot="item" slot-scope="data">
                    <div class="dropdown-line">
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  background-color="white"
                  outlined
                  @change=" changeCurrency($event, 'freightRateOth')"
                  @keydown.enter="getIndexListDropDown"
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  @change=" changeCurrency($event, 'insuranceRateOth')"
                  @keydown.enter="getIndexListDropDown"
                >
                  <template slot="item" slot-scope="data">
                    <div class="dropdown-line">
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  background-color="white"
                  outlined
                  @change=" changeCurrency($event, 'packingRateOth')"
                  @keydown.enter="getIndexListDropDown"
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  @change=" changeCurrency($event, 'interiorRateOth')"
                  @keydown.enter="getIndexListDropDown"
                >
                  <template slot="item" slot-scope="data">
                    <div class="dropdown-line">
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  @change=" changeCurrency($event, 'landingRateOth')"
                  @keydown.enter="getIndexListDropDown"
            ...
            <div class="w-full md:w-1/2">
              ...
              <div class="flex flex-col md:flex-row md:space-x-4">
                <v-combobox
                  ...
                  @change=" changeCurrency($event, 'otherRateOth')"
                  @keydown.enter="getIndexListDropDown"
