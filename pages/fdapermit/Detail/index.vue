<template>
  <div>
    <Core-HeadBarFda
      ...
      title="FDA Restricted List / FDA Restricted Detail"
      name="FDA RESTRICTED GOODS DETAIL LIST"
    ></Core-HeadBarFda>
    ...
    >
      <div class="flex flex-col md:flex-row">
        <div class="w-full md:w-3/12" v-if="!$vuetify.breakpoint.mobile">
          <div class="espx-24 bar-box-fda h-screen rounded-8">
            <div>
              <div
                class="
                  btn-bar
            ...
            >
              ...
              <div
              @click="$router.push('/fdapermit/fdacancellist/')"
              class="
                bar-btn2
                cursor-pointer
                flex
                    ...
                    >
                      ...
                      <template v-slot:item.ino="{ item }">
                        <span
                          ...
                          @click="
                            $router.push('/carmanifest/Detail/carmdetailcontrol/')
                          "
                          >{{ item.ino }}</span
                        >
                      </template>
                    </v-data-table>
                    <Core-Page color="base_carm" isExportPage="true"></Core-Page>
                  </v-card>
                </div>
              </div>
            </div>
