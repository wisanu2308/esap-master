<template>
  <div>
    <Core-Header13    
      name="FDA Restricted CANCEL List"
      action="FDA Restricted CANAEl List"
    ...
    <div>
      <div class="hx-160 esap-bg-fdacan"></div>
...
export default {
  ...
  data: () => {
    return {
      ...
      breadcrumbs: [
        {
          text: "FDA restricted Goods Cancel List",
          disabled: false,
          light: true,
          href: "/",
        },
      ...
      fdacancelTransition: [
        {
          ...
          documentTypeName: "ยกเลิกระบุ...ไม่ถูกต้อง",
          status: 1,
          remark: "",
          user: "Mint"
        },
